...
test('@regression Reconcile filled order with timecard image', async ({ page, loginPage, tempPage, clientPage, clearConnectAPI, timecardPage }) =>
{
    await loginPage.login(users.validUser5.username, users.validUser5.password);
    await loginPage.verifySuccessfulLogin();
    await loginPage.navigateToPage('tempManagerClassicView.cfm');
...
test('@regression Reconcile and Post Timecard', async ({ page, loginPage, tempPage, clientPage, clearConnectAPI, timecardPage }) =>
{
    await loginPage.login(users.validUser5.username, users.validUser5.password);
    await loginPage.verifySuccessfulLogin();
