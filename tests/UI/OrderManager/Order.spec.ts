...
test('@regression Create a filled order', async ({ page, loginPage, tempPage, clientPage, clearConnectAPI }) =>
{
    await loginPage.login(users.validUser3.username, users.validUser3.password);
    await loginPage.verifySuccessfulLogin();
    await loginPage.navigateToPage('tempManagerClassicView.cfm');
...
test('@regression Reconcile filled order', async ({ page, loginPage, tempPage, clientPage, clearConnectAPI }) =>
{
    await loginPage.login(users.validUser3.username, users.validUser3.password);
    await loginPage.verifySuccessfulLogin();
    await loginPage.navigateToPage('tempManagerClassicView.cfm');
